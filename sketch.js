...
function preload() {
  titleScreen = loadImage('img/loadingscreen.png');
  imgSkull = loadImage('img/skull.png');
  pumpkinImg = loadImage('img/sbfhead.png');
  imgBoxSkull = loadImage('img/box2.png');
  imgStone1 = loadImage('img/stone2.png');
  imgBone1 = loadImage('img/bone1.png');
  imgPlank1 = loadImage('img/plank1.png');
  monsterImg = loadImage('img/monster.png');
}
...
function propagateImpact(body, impactMagnitude, impactThreshold, originalCollisionPosition, visitedBodies = new Set()) {
  ...
  for (let result of bodiesInContact) {
    ...
    let reducedImpactMagnitude = impactMagnitude / (1 + distanceFromOriginal / 500); // Ajustar el divisor seg̼n sea necesario
